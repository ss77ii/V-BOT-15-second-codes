...
void auton_60s_skills()
{
	...
	delay(100); //
	new_goStraightCm_Front_Vision(40,
		230,
		70,
		DETECT_YELLOW_GOAL_SIG,
		front_vision,
	...
	goStraightCm_Back_Vision(distance
			+ 3,
		345,
		50,
		DETECT_RED_GOAL_SIG,
...
void auton_60s_skills_fast_version()
{
	...
	long start_time = pros::millis();
	pros::Task arm_holding_task
		(arm_moving_holding_fn, (void*)"PROS", TASK_PRIORITY_DEFAULT, TASK_STACK_DEPTH_DEFAULT, "arm_holding_task");
